...
public class PC_RelaunchClassLoader extends URLClassLoader {
	...
	public PC_RelaunchClassLoader(URL[] sources) {
		super(sources, null);
	...
	public void registerTransformer(String transformerClassName) {
		try {
			...
			// FMLRelaunchLog.log(Level.SEVERE, e, "A critical problem occured registering
			// the ASM transformer class %s", transformerClassName);
		}
	}
