package powercraft.api.hooklib.helper;
 ...
 *
 * Настоятельно рекомендую сгенерировать methods.bin самостоятельно для своей
 * версии mcp, иначе могут быть внезапные ошибки уровня "can not find target
 * method of hook".
 */
