...
/**
 * Фабрика, задающая тип инжектора хуков. Фактически, от выбора фабрики зависит
 * то, в какие участки кода попадёт хук. "Из коробки" доступно два типа
 * инжекторов: MethodEnter, который вставляет хук на входе в метод, и
 * MethodExit, который вставляет хук на каждом выходе.
 */
public abstract class HookInjectorFactory {

	/**
	 * Метод AdviceAdapter#visitInsn() - штука странная. Там почему-то вызов
	 * следующего MethodVisitor'a производится после логики, а не до, как во всех
