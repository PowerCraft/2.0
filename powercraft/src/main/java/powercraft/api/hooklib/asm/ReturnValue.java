...
public enum ReturnValue {
	...
	/**
	 * Возвращается заранее установленное примитичное значение. Можно использовать
	 * только когда целевой метод возвращает примитив.
	 */
	PRIMITIVE_CONSTANT,

	/**
	 * Возвращается null. Можно использовать только когда целевой метод возвращает
	 * объект.
	 */
	NULL,
