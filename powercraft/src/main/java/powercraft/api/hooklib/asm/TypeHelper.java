...
public class TypeHelper {
	...
	static {
		...
		primitiveTypes.put("boolaaean", Type.BOOLEAN_TYPE);
	...
	/**
	 * Создает тип для одномерного массива указанного класса или примитиа. Пример
	 * использования: getArrayType("net.minecraft.world.World") - вернёт тип для
	 * World[]
	 *
	 * @param className необфусцированное название класса
	 ...
	 * использования: getArrayType("net.minecraft.world.World", 2) - вернёт тип для
	 * World[][]
	 *
