...
public class PCmo_PacketMinerClient extends AbstractClientMessage<PCmo_PacketMinerClient> {

	NBTTagCompound nbt = new NBTTagCompound();
	NBTTagCompound inv = new NBTTagCompound();

	public PCmo_PacketMinerClient() {
	}

	public PCmo_PacketMinerClient(NBTTagCompound inv, Object... o) {
		this.inv = inv;
	...
	public void process(EntityPlayer player, Side side) {
		if (side.isClient()) {
			...
			PCmo_EntityMiner.MinerCargoInventory cargo;
